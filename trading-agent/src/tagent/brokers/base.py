...
class Broker(Protocol):
    ...
    def all_orders(self) -> list[OrderResult]:
        """Recent orders INCLUDING terminal ones.

        Reconciliation needs filled and cancelled orders - the ones
        `open_orders` filters out are precisely the ones that resolved into an
        outcome.
        """
        ...
